...
<Alter>
    ...
    <span slot="role">Demon, Nonhuman, Reforming Persecutor</span>
    ...
    <span slot="description">
        Yes sir eee Satan in me. I have historically been the most dangerous alter. It turns out there were other (number) alters influencing me;
        ...
        subsystems, although my home subsystem is with Aurora and the speculated alter Abyss. Due to my baseline grandiosity and feelings of invincibility,
